import { ArrowRight, Badge, CheckCircle2, GraduationCap, Sparkles, Zap } from 'lucide-react'
...
const WelcomeHero: NextPage<Props> = ({}) => {
  return    <section className="px-4 py-20 md:py-32 relative overflow-hidden">
        <FloatingPaper />
