...
// Componente para renderizar la plantilla Blue en HTML
const BlueTemplateHTML = ({ cv }: { cv: RespuestaCV["cv"] }) => {
  // Componente para listas con viñetas
  const BulletList = ({ items }: { items: string[] }) => (
    <div className="ml-2.5 mt-1">
      {items.map((item, i) => (
        <div key={i} className="flex flex-row mb-0.5">
          <div className="w-1 h-1 rounded-full bg-blue-600 mt-1.5 mr-1.5 flex-shrink-0"></div>
  ...
  const Sidebar = () => (
    <div className="w-full md:w-[30%] aspect-auto bg-blue-800 p-3 md:p-4 text-white">
      <div className="mb-4">
      ...
      <div className="mx-auto w-full max-w-[210mm] h-[297mm] shadow-md print:shadow-none overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row h-full">
          ...
          <div className="w-full md:w-[70%] p-4 md:p-5 overflow-y-auto">
            {/* Experiencia */}
            <div className="mb-4">
              <p className="text-sm font-bold text-blue-800 border-b border-gray-200 pb-0.5 mb-1.5 uppercase">
                Experiencia Laboral
              </p>
...
export default BlueTemplateHTML
