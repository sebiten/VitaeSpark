// CV Template: Blue Theme - Mejorado
// -----------------------------------------------------
              ...
              {cv.experiencia.map((e, i) => (
                <View key={i} style={{ marginBottom: 12 }}>
                  ...
                  >
                    ...
                    <Text style={styles.subtitleText}>{[e.fechas, e.ubicacion].filter(Boolean).join(" • ")}</Text>
                  </View>
                  <Text style={{ fontSize: 10, marginBottom: 3 }}>{e.empresa}</Text>
              ...
              {cv.formacion.map((f, i) => (
                <View key={i} style={{ marginBottom: 12 }}>
                  ...
                  >
                    ...
                    <Text style={styles.subtitleText}>{[f.fechas, f.ubicacion].filter(Boolean).join(" • ")}</Text>
                  </View>
                  {f.titulo && <Text style={styles.subtitleText}>{f.titulo}</Text>}
                </View>
              ))}
            </View>
          </View>
