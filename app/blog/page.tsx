...
import type { BlogPost } from "@/components/blog/BlogFilters";
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-[#0F0F10] text-[#F4F4F5]">
      ...
      <section className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <BlogFilters posts={posts} onFilter={handleFilter} />
        </div>
        ...
        {filteredPosts.length > 0 ? (
          ...
          <div className="rounded-2xl border border-white/10 bg-[#121217] py-16 text-center">
            <p className="text-white/60">No se encontraron guias que coincidan con tu busqueda.</p>
          </div>
        )}
